...
function Footer() {
  ...
  <nav>
    <div className="grid grid-flow-col gap-4">
      <a className="btn bg-inherit border-none text-white hover:text-black"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
